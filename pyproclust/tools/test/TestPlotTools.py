...
class Test(unittest.TestCase):
    ...
    def test_normalize(self):
        ...
        numpy.testing.assert_array_almost_equal(pyproclust.tools.plotTools.normalize(test_list, 2), rescaled, 3)
   
    def test_normalize_in_range(self):
        mylist =[255,40,35,2,245]
        norm = pyproclust.tools.plotTools.normalize_in_range(mylist,0.3,1)
    ...
    def test_remove_zeros(self):
        ...
        numpy.testing.assert_array_almost_equal(pyproclust.tools.plotTools.remove_zeros(mylist), expected)
        
    def test_tuple_to_int(self):
        self.assertItemsEqual(pyproclust.tools.plotTools.tuple_to_int((0.1,0.6,7.3,-3.2)), (0,0,7,-3))
