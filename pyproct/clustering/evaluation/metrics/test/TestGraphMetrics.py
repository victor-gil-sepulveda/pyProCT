...
from pyproct.clustering.evaluation.metrics.graphMetrics import getClusterAndComplementary, W, d, vol,\
...
class TestGraphMetrics(unittest.TestCase):
    ...
    def test_getClusterAndComplementary(self):
        ...
        A,Acomp = getClusterAndComplementary(1,clustering.clusters)
        A.sort() 
        Acomp.sort()
